...
enum MacroCatalog {
  ...
  static let all: [Macro] = [
    .init(id: "protein",       label: String(localized: "Protein", comment: "Macro name"),        unit: "g",    defaultColorHex: "#ef4444",
          defaultMin: 100,  defaultMax: 140,   defaultVisible: true,  source: .entrySum(.protein)),
    .init(id: "fat",           label: String(localized: "Fat", comment: "Macro name"),            unit: "g",    defaultColorHex: "#f59e0b",
          defaultMin: 50,   defaultMax: 80,    defaultVisible: true,  source: .entrySum(.fat)),
    .init(id: "saturatedFat",  label: String(localized: "Saturated Fat", comment: "Macro name"),  unit: "g",    defaultColorHex: "#fb923c",
          defaultMin: 0,    defaultMax: 20,    defaultVisible: false, source: .entrySum(.saturatedFat)),
    .init(id: "carbs",         label: String(localized: "Carbs", comment: "Macro name"),          unit: "g",    defaultColorHex: "#3b82f6",
          defaultMin: 150,  defaultMax: 250,   defaultVisible: true,  source: .entrySum(.carbs)),
    .init(id: "sugar",         label: String(localized: "Sugar", comment: "Macro name"),          unit: "g",    defaultColorHex: "#ec4899",
          defaultMin: 0,    defaultMax: 50,    defaultVisible: false, source: .entrySum(.sugar)),
    .init(id: "fiber",         label: String(localized: "Fiber", comment: "Macro name"),          unit: "g",    defaultColorHex: "#10b981",
          defaultMin: 25,   defaultMax: 35,    defaultVisible: true,  source: .entrySum(.fiber)),
    .init(id: "alcohol",       label: String(localized: "Alcohol", comment: "Macro name"),        unit: "g",    defaultColorHex: "#a855f7",
          defaultMin: 0,    defaultMax: 14,    defaultVisible: false, source: .entrySum(.alcohol)),
    .init(id: "kcal",          label: String(localized: "Kcal", comment: "Macro name"),           unit: "kcal", defaultColorHex: "#eab308",
          defaultMin: 1800, defaultMax: 2400,  defaultVisible: true,  source: .entrySum(.kcal)),
    .init(id: "sodium",        label: String(localized: "Sodium", comment: "Macro name"),         unit: "mg",   defaultColorHex: "#64748b",
          defaultMin: 0,    defaultMax: 2300,  defaultVisible: false, source: .entrySum(.sodium)),
    .init(id: "cholesterol",   label: String(localized: "Cholesterol", comment: "Macro name"),    unit: "mg",   defaultColorHex: "#dc2626",
          defaultMin: 0,    defaultMax: 300,   defaultVisible: false, source: .entrySum(.cholesterol)),
    .init(id: "potassium",     label: String(localized: "Potassium", comment: "Macro name"),      unit: "mg",   defaultColorHex: "#14b8a6",
          defaultMin: 3500, defaultMax: 4700,  defaultVisible: false, source: .entrySum(.potassium)),
    .init(id: "water",         label: String(localized: "Water", comment: "Macro name"),          unit: "ml",   defaultColorHex: "#06b6d4",
          defaultMin: 2000, defaultMax: 3000,  defaultVisible: false, source: .entrySum(.water)),
    .init(id: "fasting",       label: String(localized: "Fasting", comment: "Macro name"),        unit: "h",    defaultColorHex: "#8b5cf6",
