...
func noteAirReadingChange(id: String) { noteChange(recordName: AirReadingCloudKitSchema.recordName(for: id), kind: "airReading") }
func noteAirReadingDeletion(id: String) { noteDeletion(recordName: AirReadingCloudKitSchema.recordName(for: id), kind: "airReading") }
