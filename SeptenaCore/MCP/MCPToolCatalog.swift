  ...
  static var tasks: [MCPTool] {
    [
      ...
      MCPTool(name: "tasks_get",
              description: "Inspect a single task by id: title, status, area, project, scheduled, deadline, today, completedAt, source, and a compact conversation summary. One call answers 'where is this task and what's its state?' regardless of view or status.",
      ...
      MCPTool(name: "tasks_update",
              description: "Update fields on an existing task. Any subset of title, today, scheduled, deadline, area, project, status (cancelled).",
              inputSchema: ["type": "object", "required": ["id"], "properties": [
                "id": ["type": "string"],
                "title": ["type": "string"],
                "today": ["type": "boolean"],
